...
public class bplustree {
		...
		while (currNode != null) {
			...
			for (DictionaryPair dp : dps) {
				...
				if (lowerBound <= dp.key && dp.key <= upperBound) {
					values.add(Double.parseDouble(dp.value));
				}
			}
	...
	public static void main(String[] args) {
		...
		/*if (args.length != 1) {
			System.err.println("usage: java bplustree <input_file_name>");
			System.exit(-1);
		}*/
		...
		try {
			...
			int orderInput, empID, nEmp, choice;
			String noLeavesInput;
			
			System.out.print("1. Initialize\n2. Insert\n3. Delete\n4. Search\n5. Exit\nEnter your choice: ");
			choice = s.nextInt();
			...
			while (choice != 5) {
				...
				switch (choice) {
					...
					case 1:
						...
						orderInput = s.nextInt();
						bpt = new bplustree(orderInput);
						break;
					...
					case 2:
						...
						noLeavesInput = s.next();

						bpt.insert(empID, noLeavesInput);
						break;
					...
					case 4:
						...
						//else {
							...
							System.out.print("\n***Search***\n\nEnter Employee ID: ");
							empID = s.nextInt();
							String value = bpt.search(empID);
							result = (value == null) ? "Null" :(value);
						//}
						
						if(result == "Null") System.out.println("Employee not found");
						else System.out.println("Employee has " + result + " leaves remaining");
